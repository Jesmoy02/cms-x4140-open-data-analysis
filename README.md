...
- The overall procedure for computing integrated luminosity with `brilcalc`, JSON files, and normtags follows the official CMS Open Data guide to luminosity calculation:  
